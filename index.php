                        ...
                        <div class="row">
                            <div class="col-xl-8 col-lg-9 col-md-11 col-sm-10">
                                <div class="hero__caption">
                                    <span data-animation="fadeInUp" data-delay="0.2s">dengan Wildans HairCut</span>
                                    <h1 data-animation="fadeInUp" data-delay="0.5s">buat dirimu jadi keren sekarang!</h1>
                                </div>
                            </div>
                        </div>
                    </div>          
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="about-caption">
                            ...
                            <div class="section-tittle section-tittle3 mb-35">
                                <span>Wildans HairCut</span>
                                <h2>potong rambut yang kamu inginkan</h2>
                            </div>
                            <p class="mb-30 pera-bottom">Menghadirkan gaya rambut yang sesuai dengan trend masa sekarang.</p>
                            <p class="pera-top mb-50">Jadi lebih percaya diri berkat tampil keren.</p>
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-xl-7 col-lg-8 col-md-11 col-sm-11">
                        <div class="section-tittle text-center mb-90">
                            <span>Spesial Layanan</span>
                            <h2>Layanan Spesial dari kami</h2>
                        </div>
                    </div>
                </div>
                <!-- Section caption -->
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="services-caption text-center mb-30">
                            ...
                            <div class="service-cap">
                                ...
                                <p>membuat tampilan yang sesuai dengan kamu inginkan</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="services-caption active text-center mb-30">
                            ...
                            <div class="service-cap">
                                <h4><a href="#">Pijat Kepala</a></h4>
                                <p>Kepala kamu terasa pegal setelah lama proses pencukuran tenang kami ada layanan untuk memijat kepala kamu biar rileks dan tidak merasakan pegal saat meninggalkan tempat kami.</p>
                            </div>
                        </div>
                    </div> 
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="services-caption text-center mb-30">
                            ...
                            <div class="service-cap">
                                <h4><a href="#">Coloring</a></h4>
                                <p>warnai rambutmu dengan style sehati darimu.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-8 col-lg-8 col-md-11 col-sm-11">
                        <div class="section-tittle text-center mb-100">
                            ...
                            <h2>kami memiliki ahli pencukur yang sudah bersertifikat, jadi jangan ragu!</h2>
                        </div>
                    </div>
                </div>
